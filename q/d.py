...
list1=[0.9956,0.9890,0.9509,0.6937,0.3617,0.3603,0.3295,0.2781,0.2463,0.2164,0.1914,0.1702,0.1515,0.1395,0.1285,0.1175,0.1098,0.1008,0.1044,0.1123,0.1159,0.1255,0.1212,0.1124,0.1079,0.1186]
...
pl.plot(pointlist,MA1,label="11154 Pa",color='red',linestyle='-',marker='o')
pl.plot(pointlist,MA2,label="20845 Pa",color='blue',linestyle='-',marker='o')
pl.plot(pointlist,MA3,label="51390 Pa",color='green',linestyle='-',marker='o')
pl.plot(pointlist,MA4,label="81516 Pa",color='orange',linestyle='-',marker='o')
pl.title("Mach number distribution")
pl.xlabel("point")
pl.ylabel("MA")
pl.legend()
pl.savefig("E:\\vscodeProject\\Githubcode\\DeepLearning_notes\\1.jpg")
pl.show()
