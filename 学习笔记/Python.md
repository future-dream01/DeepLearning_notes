...
## python 的语言
总述：python是一门先进的、简洁的、可拓展性强的面向对象编程的语言，python中
1. 数据：
   - 数值类型
...
2. 语句
   ...
   - 复合语句：
      ...
      - **match**
3. 类
   - 地位：类，体现了编程领域的重要思想：**面向对象编程**，遵循这一思想，类本质是定义了一类**对象**可以具有的**属性**和可以使用的**方法**的代码块，其在面向过程编程的基础之上，将问题的解决转而以对象为中心，将任务分配给了功能不同的各类对象，各自解决，随着我们对类内属性和方法的补充，每类对象功能越来越完整，可以完成的任务越来越专一、复杂，就可以越来越好的完成我们分配给他的任务，这样，问题就会更容易解决。
   - 结构：
     - ```python
       class Animal()：
           number=0                             # 类变量
